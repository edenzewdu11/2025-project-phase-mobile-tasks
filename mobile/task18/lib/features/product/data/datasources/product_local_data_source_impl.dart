...
import 'package:contracts_of_data_sources/core/data/sample_products.dart';
  ...
  Future<List<ProductModel>> getAllProductModels() async {
    try {
      ...
      if (jsonString != null && jsonString.isNotEmpty) {
        ...
        // Initialize with sample products if cache is empty
        final sampleProducts = SampleProducts.sampleProducts;
        await cacheProductModels(sampleProducts);
